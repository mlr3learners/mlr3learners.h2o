...
#'
#' @name mlr_learners_regr.h2odeeplearning
#'
#' @description
#' Regression feed-forward multilayer artificial neural network learner.
#' Class [h2o::h2o.deeplearning()] from package \CRANpkg{h2o}.
#'
#' @templateVar id regr.h2odeeplearning
#' @template section_dictionary_learner
#'
#' @export
#' @template seealso_learner
#' @template example
LearnerRegrH2ODeeplearning = R6Class("LearnerRegrH2ODeeplearning",
  inherit = LearnerRegr,
  public = list(
    ...
    initialize = function() {
      ...
      ps = ParamSet$new(
        params = list(
          ...
          ParamDbl$new("class_sampling_factors", default = NULL,
            special_vals = list(NULL), tags = "train"),
          ParamDbl$new("max_after_balance_size", default = 5, tags = "train"),
          ParamInt$new("max_hit_ratio_k", default = 0, lower = 0,
            tags = "train"),
          # checkpoint
          ...
          ParamInt$new("train_samples_per_iteration", default = -2, lower = -2,
            tags = "train"),
          ...
          ParamDbl$new("epsilon", default = 1e-08, lower = 1e-10, upper = 1e-4,
            tags = "train"),
          ...
          ParamFct$new("distribution",
            levels = c("AUTO", "gaussian", "poisson", "gamma", "tweedie",
              "laplace", "huber", "quantile"), default = "AUTO",
            tags = "train"),
          ...
          ParamDbl$new("stopping_tolerance", default = 0, lower = 0,
            tags = "train"),
          ParamDbl$new("max_runtime_secs", default = 0, lower = 0,
            tags = "train"),
          ...
          ParamFct$new("categorical_encoding",
            levels = c("AUTO", "Enum", "OneHotInternal",
