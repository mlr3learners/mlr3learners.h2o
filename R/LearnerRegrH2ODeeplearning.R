#' @title H2O Deep Learning Regression Learner
#'
#' @name mlr_learners_regr.h2odeeplearning
#'
#' @description
#' Feed-forward multilayer artificial neural network regression learner.
      ...
      ps = ParamSet$new(
        params = list(
          ...
          ParamFct$new("distribution",
            ...
            tags = "train"),
          # distributin - Only classification binomial and multinomal
          ...
          # stopping_metric - Only classification  "logloss", "AUC",
          # "lift_top_group", "misclassification", "AUCPR",
