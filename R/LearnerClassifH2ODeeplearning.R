#' @title Classification H2O DeepLearning Learner
#'
#' @aliases mlr_learners_classif.h2odeeplearning
    ...
    initialize = function() {
      ps = ParamSet$new(
        params = list(
          ...
          ParamDbl$new("classification_stop", default = 0, lower = -1, tags = "train"),
          # regression_stop
